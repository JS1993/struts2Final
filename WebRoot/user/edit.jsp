...
<HTML>
	...
	<body>
		...
		<%--修改的时候，必须告诉服务器，修改哪个用户 --%>
		<s:hidden name="userID" value="<s:property value='userID'/>" />
			<table cellSpacing="1" cellPadding="5" width="100%" align="center" bgColor="#eeeeee" style="border: 1px solid #8ba7e3" border="0">
				...
				<tr>
					...
					<td class="ta_01" bgColor="#ffffff">
						<s:select name="education" list="{'研究生','本科','高中','幼儿园'}" headerKey="" headerValue="---选择学历---"></s:select>
					</td>
				</tr>
				<tr>
					<td align="center" bgColor="#f5fafe" class="ta_01">
				...
				<tr>
					...
					<s:url action="download" namespace="/user" var="url" >
						...
						<div id="mydiv" style="display:none"><s:file name="upload" size="30"></s:file></div>
						<!-- <input type="button" value="重新上传" onclick="mydiv.style.display='inline'"/>  -->
						<input type="button" value="重新上传" onclick="showFile()" id="showBtn">
						<input type="button" value="取消上传" onclick="cancelFile()" id="cancelBtn">
						<script type="text/javascript">
							function showFile(){
